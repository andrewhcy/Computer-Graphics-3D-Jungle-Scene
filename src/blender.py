...
def process_line(line):
	...
	if fields[0] == '#':
		...
		label = 'vertex'
		#Filters out mesh components with 4 vertexes
		if len(fields) != 4:
			return None

	elif fields[0] == 'vt':
		#Filters out vertex components with 3 vertex textures
	...
	# check this
		...
		label = 'face'
		#Filters out mesh components with 5 or 6 faces
		if len(fields) != 4 and len(fields) != 5:
			return None
		#For every face component only obtain the corresponding vertexes making the face
