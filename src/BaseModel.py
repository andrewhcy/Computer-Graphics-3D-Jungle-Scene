...
class BaseModel:
    ...
    def __init__(self, scene, M=poseMatrix(), mesh=Mesh(), color=[1., 1., 1.], primitive=GL_TRIANGLES, visible=True):
        ...
        # Ensures the model is not rendered
        ...
        # Dictonary of Vertec Buffer Objects
        self.vbos = {}
        ...
        # Vertex Array Object to pack all buffers for rendering in the GPU (see lecture on OpenGL)
        self.vao = glGenVertexArrays(1)

        # Buffer to store indices, if using shared vertex representation
    ...
    def bind(self):
        ...
        # Unbind the VAO and VBO when we're done to avoid side effects
        glBindVertexArray(0)
